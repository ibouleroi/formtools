...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('clean-blog.css', '', array ());
  $response->addStylesheet('clean-blog.min.css', '', array ());
  $response->addJavascript('bootstrap.js', '', array ());
  $response->addJavascript('bootstrap.min.js', '', array ());
  $response->addJavascript('clean-blog.js', '', array ());
  $response->addJavascript('clean-blog.min.js', '', array ());
